...
import { ArrowRight, Mail, MapPin, Send, CheckCircle } from "lucide-react";
  ...
  if (submitted) {
    return (
      <div className="glass-card rounded-2xl p-12 text-center">
        ...
        <p className="text-muted">We&apos;ll get back to you within 24 hours with a plan.</p>
      </div>
    );
  }
            ...
            <div className="lg:col-span-2 space-y-5">
              <FadeIn delay={0.1}>
                <div className="glass-card rounded-2xl p-8">
                  <h3 className="font-heading text-h3 text-foreground mb-4">Direct contact</h3>
                  <div className="space-y-4">
                    <a href="mailto:younus@zavia-ai.com" className="flex items-center gap-3 text-sm text-muted hover:text-foreground transition-colors">
                      <Mail size={16} className="text-accent" />
                      younus@zavia-ai.com
                    </a>
                    <a href="mailto:ghaarib.khurshid@zavia-ai.com" className="flex items-center gap-3 text-sm text-muted hover:text-foreground transition-colors">
                      <Mail size={16} className="text-accent" />
